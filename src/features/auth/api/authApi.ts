import { api, rawApi } from '../../../shared/api/httpClient'
...
export const authApi = {
  login: (body: LoginRequest) => rawApi.post<AuthResponse>('/auth/login', body).then((response) => response.data),
  refresh: (body: RefreshRequest) => rawApi.post<AuthResponse>('/auth/refresh', body).then((response) => response.data),
  ...
  registerRestaurant: (body: RegisterRestaurantRequest) => rawApi.post<AuthResponse>('/auth/register-restaurant', body).then((response) => response.data),
