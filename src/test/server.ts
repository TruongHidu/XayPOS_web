...
export const adminRestaurant: RestaurantResponse = { id: 'restaurant-1', code: 'DEMO01', name: 'Demo Restaurant', legalName: 'Demo Restaurant LLC', phone: '+84123456789', timezone: 'Asia/Ho_Chi_Minh', currencyCode: 'VND', status: 'ACTIVE', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-08-27T00:00:00Z', effectiveSubscription: { id: adminSubscription.id, packageCode: adminSubscription.packageCode, status: adminSubscription.status, startAt: adminSubscription.startAt, endAt: adminSubscription.endAt, autoRenew: adminSubscription.autoRenew } }
